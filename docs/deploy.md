...
- `WHATSAPP_DEV_BYPASS_TOKEN` (temporário) — quando definido, pula a troca OAuth code→token e usa este token + WABA fixo; use apenas para screencast em app em desenvolvimento.
